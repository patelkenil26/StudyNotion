    ...
    return (
      <div>
        ...
        {loading ? (
          ...
          <div>
            {/* Chart + Stats */}
            <div className="my-4 flex flex-col lg:flex-row lg:space-x-4 space-y-4 lg:space-y-0 h-auto lg:h-[490px]">
              {/* Render chart / graph */}
              {totalAmount > 0 || totalStudents > 0 ? (
                <div className="flex-1 rounded-md bg-richblack-800 p-4 lg:p-6">
                  <InstructorChart courses={instructorData} />
                </div>
              ) : (
                <div className="flex-1 rounded-md bg-richblack-800 p-4 lg:p-6">
                  <p className="text-lg font-bold text-richblack-5">Visualize</p>
                  <p className="mt-4 text-base lg:text-xl font-medium text-richblack-50">
                    Not Enough Data To Visualize
                  </p>
                </div>
              )}
              {/* Total Statistics */}
              <div className="flex lg:min-w-[250px] flex-col rounded-md bg-richblack-800 p-4 lg:p-6">
            ...
            {/* Courses List */}
            <div className="rounded-md bg-richblack-800 p-4 lg:p-6">
                ...
                {courses.slice(0, 3).map((course) => (
                  <div key={course._id} className="w-full">
                    <img
                      ...
                      className="h-[180px] lg:h-[201px] w-full rounded-md object-cover"
                    />
          ...
          <div className="mt-20 rounded-md bg-richblack-800 p-6 py-20">
            ...
            <Link to="/dashboard/add-course">
              <p className="mt-1 text-center text-base lg:text-lg font-semibold text-yellow-50">
                Create a course
              </p>
            </Link>
          </div>
